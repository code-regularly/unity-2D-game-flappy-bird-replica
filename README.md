# Game Replica: Flappy Bird

In order to learn Unity 2D game development, I created my first-ever game, Flappy Bird. The game implements the several beginner-level concepts of Unity game engine and C# language. I worked with and developed the understanding of the following aspects of the entire ecosystem.

## Project Timeline
I built this game following a YouTube playlist online in March, 2023.

## Technical Overview of the Game

- **Understanding Unity Game Engine Layout:** The project helped me learn the basic layout of Unity. I understood the hierarchy, scene, inspector, project and console windows.
...
- **Object Components:** By default, a "transform" component is available in Unity for all the objects. We can add more components by clicking on the "Add Components" button. Some of the objects that I used included the bird, its wings and the pipes that move towards the bird, giving an illusion of bird's movement along the x-axis.
...
Overall, it was an amazing learning experience. I could not leave from in front of my laptop the entire time! I hope to create more games with even more amazing features, like sound effects, collision effects, animations, etc.
